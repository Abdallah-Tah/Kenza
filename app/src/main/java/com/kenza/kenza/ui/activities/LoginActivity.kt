package com.kenza.kenza.ui.activities
...
import com.kenza.kenza.MainApplication
import com.kenza.kenza.R
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        PublicClientApplication.createSingleAccountPublicClientApplication(this,
            ...
            object : IPublicClientApplication.ISingleAccountApplicationCreatedListener {
                override fun onCreated(application: ISingleAccountPublicClientApplication) {
                    ...
                    (application.context.applicationContext as MainApplication).msalInstance = application
                    loadAccount()
        ...
        loginButton.setOnClickListener {
            val app = (application as? MainApplication)?.msalInstance
            app?.let {
